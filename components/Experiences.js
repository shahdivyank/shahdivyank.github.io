...
const experiences = [
    {
        ...
        points: ["Construct Concourse CI pipelines to check linting, formatting, whitesourcing, & testing",
    ...
    },
    {
        ...
        points: ["Manage 6+ developer team to develop driver interface with QT C++",
    ...
    },
    {
        ...
        time: "October 2021 - Present",
        location: "Riverside, California",
        points: ["Host 16+ web development workshops covering React, Next.js, CSS, Tailwind",
    ...
    },
    {
        ...
        points: ["Moderate summer camps including Roblox Studio, Minecraft Modifications, Python/Scratch programming",
