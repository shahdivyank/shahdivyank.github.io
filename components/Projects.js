...
const projects = [
    {
        title: "Wizard Chess",
        description: "Wizard Chess brings to life J.K Rowling's invention. Players move pieces using voice commands and the chess board automatically moves the pieces.",
    ...
    },
    {
        ...
        description: "A minimalist website, taking inspiration from Apple's colors, displaying information regarding past experiences, projects, and methods to contact me.",
    ...
    },
    {
        ...
        description: "An Arduino based car utilizing DC motors controlled by an H-bridge and an IR sensor to be controlled remotely through an IR remote.",
    ...
    },
    {
        ...
        description: "A beginner friendly and acessible Arduino library to use with L298N/L293D motor drivers. Control motors in an easier and more intutitve manner.",
    ...
    },
    {
        ...
        description: "Website to display information about recruitment, practices Google Calender integration to easily post announcements",
...
const Projects = () => {
    return (
        <section id="projects" className="font-lexend  flex justify-center items-center flex-col bg-gradient-to-b z-20 bg-gradient-to-b  from-orange-300 to-amber-300 ">
