...
const About = () => {
  return (
    <section
      id="about"
      className="flex pb-20 justify-center items-center font-lexend flex-col -z-20 bg-gradient-to-b from-purple-500 to-purple-300 "
    >
      ...
      <Row className=" w-11/12">
        <Col xl={12} className="flex justify-center items-center">
          <p className="text-center text-2xl">
            ...
            alerts from internet providing devices. Outside the industry and
            classroom, I love to go on bike rides throughout the city and
            explore new places. Additionally, I love hiking through local trails
            and taking time to escape from the city and free myself from all
            distractions.
          </p>
        </Col>
        <Col xl={6} className="">
